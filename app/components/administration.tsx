        ...
        <Fade duration={200}>
          ...
          >
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              ...
              <Grid xs={12} lg={5}>
                <Textarea
                  name="Outlined"
                  placeholder="Must be numbers and letters"
                  variant="outlined"
                />
              </Grid>
            </Grid>
          ...
          >
            ...
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              ...
              <Typography level="body-sm">
                Current Speed:100M Full Duplex
              </Typography>
            </Grid>
          </Sheet>
          ...
          >
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              ...
              <Grid xs={12} lg={5}>
                <Select defaultValue="49" variant="outlined">
                  ...
                  <Option value="58">
                    (GMT+08:00)Irkutsk grams, Ulaanbaatar
                  </Option>
                  ...
                  <Option value="71">
                    (GMT+11:00)Magadan, Solomon Islands, New Caledonia and more
                  </Option>
                  <Option value="72">
                    (GMT+12:00)Fiji Islands, Kamchatka Peninsula, the Marshall
                    Islands
                  </Option>
            ...
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              ...
              <Typography level="body-sm">
                Current date and time has synced with the Internet.
              </Typography>
            </Grid>
          </Sheet>
...
>Reboot</Button> */}
            ...
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              ...
              <Typography level="body-sm">
                Current Firmware Version:v23.05.3
              </Typography>
            </Grid>
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              <Grid xs={12} lg={3}>
              ...
              <Grid xs={12} lg={5}>
                <Checkbox label="Enable" variant="solid" defaultChecked />
                <Typography level="body-sm">
                  During 03:00~05:00 (a.m.) each day,if no one is using the
                  router, the router will auto-reboot.
                </Typography>
              </Grid>
            </Grid>
          </Sheet>
